    ...
    <div class="mwsgeneric-base-html parbase section">
      <div class="gc-subway-wrapper">
        <nav class="provisional gc-subway wb-init gc-subway-inited no-blink" id="wb-auto-4">
          ...
          <ul>
            <li>
              <router-link :to="{name:'home'}"><a href="#" class=" hidden-xs hidden-sm" aria-current="page" tabindex="0">Program Overview</a></router-link>
              <router-link :to="{name:'home'}"><a href="#" class=" hidden-md hidden-lg" aria-current="page" tabindex="0">Program Overview</a></router-link>
            </li>
            <li>
              <a href="#" class=" active hidden-xs hidden-sm">congratulations</a
              ><a href="#" class=" active hidden-xs hidden-sm hidden-md hidden-lg">congratulation</a>
              <a href="#" class=" active visible-xs visible-sm hidden-xs hidden-sm">congratulation</a
              ><a href="#" class="active visible-xs visible-sm hidden-md hidden-lg">congratulation</a>
            </li>
      ...
      <section class="gc-subway-section">
        <hgroup style="margin-top: 5%">
          <p> congratulations your Basic Income Pilot application has been received</p>
        </hgroup>
        ...
        <p>
          For more information, about your application contact &nbsp;<a href="#">Basic Income Pilot Program</a>.
        </p>
